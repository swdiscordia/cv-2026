...
export const JOURNEY_MILESTONES: JourneyMilestone[] = [
  ...
  },
  {
    ...
    type: 'work',
    technologies: ['Crypto Casino', 'Marketing', 'Prospecting', 'Lead Generation', 'Partner Recruitment', 'Partnerships', 'Outbound'],
    color: COLORS.MARKERS.work,
  },
  {
    id: 'current',
...
export const STORY_SECTIONS: StorySection[] = [
  ...
  },
  {
    ...
    title: 'Growth',
    subtitle: 'Scaling up',
    milestoneIds: ['project-solturtle', 'work-bitcasino'],
  },
  {
    id: 'present',
    title: 'Present',
